...
template<> static 
bool op_greater<bool>(bool a, bool b)
{
...
template<> static 
bool op_less<bool>(bool a, bool b)
{
	FAIL("bool < bool is not a valid operation");
	return false;
}
...
template<> static 
bool op_addition<bool>(bool a, bool b)
{
	FAIL("bool + bool is not a valid operation");
	return false;
}
...
template<> static 
string op_subtraction<string>(string a, string b)
{
...
template<> static 
bool op_subtraction<bool>(bool a, bool b)
{
	FAIL("bool - bool is not a valid operation");
	return false;
}
...
template<> static 
bool op_multiplication<bool>(bool a, bool b)
{
	FAIL("bool * bool is not a valid operation");
	return false;
}
...
template<> static 
bool op_division<bool>(bool a, bool b)
{
	FAIL("bool / bool is not a valid operation");
	return false;
}
									 ...
									 const FunctionMapping &functions)
{
	...
	cells_t::const_iterator i = node->begin();

	// Call the function and return the result
	const string name = getBranchFunctionName(i);
	const cells_t parameters = buildParameters(i, node->end(), functions);
