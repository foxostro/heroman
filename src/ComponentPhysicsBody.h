...
{
public:
	ComponentPhysicsBody(BlackBoardUID _uid, BlackBoard *_blackBoard);
...
private:
	...
	void handleMessageRequestApplyForce(Message &m);
	...
	void createGeomMesh(float kilograms);
