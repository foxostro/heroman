					  ...
					  JUSTIFY justify)
{
    ...
    else
    {
        ...
        string pad;			for(size_t i=0; i<charsRemaining; ++i) pad += padWith;
        string padLeftHalf;	for(size_t i=0; i<leftCharsRemaining; ++i) padLeftHalf += padWith;
        string padRightHalf;	for(size_t i=0; i<rightCharsRemaining; ++i) padRightHalf += padWith;
