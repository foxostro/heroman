...
float getAngleFromDirection(Direction facing)
{
	...
	switch(facing)
	{
	case SouthWest: return 0.0f;
	case South:     return a;
	case SouthEast: return a * 2.0f;
	case East:      return a * 3.0f;
	case NorthEast: return a * 4.0f;
	case North:     return a * 5.0f;
	case NorthWest: return a * 6.0f;
	case West:      return a * 7.0f;
	}
...
Action getActionFromAngle(float r)
{
