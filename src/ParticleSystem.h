...
private:
	...
	struct ParticleBatch
	{
		...
		ResourceBufferVerticesPtr vertices;
		ResourceBufferColorsPtr colors;
		ResourceBufferTexCoordsPtr texcoords;

		/** Default constructor */
		ParticleBatch()
		: vertices(new ResourceBufferVertices()),
		  colors(new ResourceBufferColors()),
		  texcoords(new ResourceBufferTexCoords())
		{}
	};
